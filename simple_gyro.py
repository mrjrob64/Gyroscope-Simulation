...
def update(frame):
    ...
    ax.quiver([0], [0], [0], [angular_velocity_x[frame * STEPS + START]], [angular_velocity_y[frame * STEPS + START]], [angular_velocity_z[frame * STEPS + START]], color='green', label='Angular Velocity Vector', length=0.8)
